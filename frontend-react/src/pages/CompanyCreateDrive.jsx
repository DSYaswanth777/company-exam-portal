      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="bg-white px-10 py-8 border-b border-slate-100 flex justify-between items-center shrink-0">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h2 className="text-3xl font-[500] text-slate-900 tracking-tight leading-none mb-2">
                Configure Drive
              </h2>
              <p className="text-sm font-[500] text-slate-400">
                Setting up assessment for{" "}
        ...
        <main className="flex-1 overflow-auto p-12 bg-[#F8FAFC]">
          ...
          >
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-12 space-y-10 animate-in slide-in-from-bottom-6 duration-500">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div className="space-y-3">
                  <label className="text-[12px] font-[500] text-slate-400 uppercase tracking-widest ml-1">
                    Drive Title
                  </label>
                  <input
                    type="text"
                    ...
                    placeholder="e.g. SDE Graduate Engineer Trainee"
                    className="w-full px-8 py-3 mt-2  bg-slate-50 border border-gray-300 rounded-xl focus:ring-4 focus:ring-blue-600/5 focus:bg-white transition-all outline-none font-bold text-slate-900"
                    required
                  />
                </div>
                <div className="space-y-3">
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full px-8 py-3 mt-2 bg-slate-50 border border-gray-300 rounded-xl focus:ring-4 focus:ring-blue-600/5 focus:bg-white transition-all outline-none font-bold text-slate-900 appearance-none"
                  >
                ...
                <div className="md:col-span-2 space-y-3">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows="4"
                    placeholder="Describe the roles, expectations and instructions for students..."
                    className="w-full px-8 py-6 bg-slate-50 border border-gray-300 rounded-2xl mt-2 focus:ring-4 focus:ring-blue-600/5 focus:bg-white transition-all outline-none font-medium text-slate-700 leading-relaxed resize-none"
                    required
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                <div className="space-y-3">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full px-8 py-2 mt-2 bg-slate-50 border border-gray-200 rounded-xl focus:ring-4 focus:ring-blue-600/5 focus:bg-white transition-all outline-none font-bold text-slate-900"
                    required
                  />
                </div>
                {/* Window Starts */}
            ...
            {/* 03 Target Audience */}
            <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-12 space-y-10 animate-in slide-in-from-bottom-6 duration-700 delay-200">
              <div className="flex justify-between items-center">
                ...
                <button
                  type="button"
                  onClick={addTarget}
                  className="flex items-center gap-2 bg-blue-50 text-blue-600 px-6 py-3 rounded-xl font-[500] text-[10px] uppercase tracking-widest hover:bg-blue-600 hover:text-white transition-all"
                >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="space-y-3">
                        ...
                        <select
                          ...
                          className="w-full px-8 py-3 bg-white border-none rounded-xl focus:ring-4 focus:ring-blue-600/5 transition-all outline-none font-bold text-slate-900"
                        >
                        ...
                        {target.college_id === null &&
                          (!colleges.length ||
                            ...
                            <input
                              ...
                              className="w-full mt-3 px-8 py-4 bg-white border border-blue-100 rounded-[15px] focus:ring-4 focus:ring-blue-600/5 transition-all outline-none font-medium text-slate-900"
                            />
                          )}
                      </div>
                      <div className="space-y-3">
                        <label className="text-[10px] font-[500] text-slate-400 uppercase tracking-widest ml-1">
                          Department
                        </label>
                        <select
                          value={
            ...
            <div className="flex justify-end gap-6 pt-10">
              <button
                type="button"
                onClick={() => navigate("/company-dashboard")}
                className="px-12 py-3 bg-slate-100 text-slate-500 rounded-[24px] font-[500] text-xs uppercase tracking-widest hover:bg-slate-200 transition-all active:scale-95"
              >
                Cancel
              </button>
              <button
                ...
                className="flex items-center gap-4 px-12 py-3 bg-blue-600 text-white rounded-[24px] font-[500] text-xs uppercase tracking-widest shadow-2xl shadow-blue-500/30 hover:bg-blue-700 transition-all active:scale-95"
              >
                {isSubmitting
                  ? "Processing..."
                  : driveId
