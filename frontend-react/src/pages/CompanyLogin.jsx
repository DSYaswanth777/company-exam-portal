...
export default function CompanyLogin() {
  ...
  const submit = async (e) => {
    ...
    try {
      const res = await companyService.login(username, password);
      const data = res.data;
  ...
  return (
    <div className="min-h-screen bg-[#F0F2F5] flex items-center justify-center p-6 font-['Poppins']">
      <div className="w-full max-w-[480px] bg-white rounded-xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] overflow-hidden animate-in fade-in zoom-in duration-500">
